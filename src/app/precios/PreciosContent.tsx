                ...
                >
                  ...
                  {opt.badge && (
                    <motion.span
                      ...
                      animate={selected === opt.id ? { scale: [1, 1.08, 1] } : {}}
              ...
              <div className="p-10 pt-12 lg:border-r lg:border-gray-100">
                <AnimatePresence mode="wait">
                  ...
                  >
                    ...
                    {active.savingsNote && (
                      <motion.p
                        className="mt-3 inline-flex items-center gap-1.5 rounded-full bg-green-50 px-3 py-1 text-xs font-semibold text-green-700 ring-1 ring-green-100"
